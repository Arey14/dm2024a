...
PARAM <- list()
PARAM$dataset <- "~/Desktop/ITBA/Mineria de Datos/datasets/dataset_pequeno.csv"
...
setwd("~/Desktop/ITBA/Mineria de Datos/dm2024a/src/CatastropheAnalysis/Modelos Propios/")
...
dir.create(paste0("~/Desktop/ITBA/Mineria de Datos/dm2024a/src/CatastropheAnalysis/Modelos Propios/exp/", PARAM$experimento, "/"), showWarnings = FALSE)
# Establezco el Working Directory DEL EXPERIMENTO
setwd(paste0("~/Desktop/ITBA/Mineria de Datos/dm2024a/src/CatastropheAnalysis/Modelos Propios/exp/", PARAM$experimento, "/"))
