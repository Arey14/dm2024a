...
dir.create("~/Desktop/ITBA/Mineria de Datos/dm2024a/src/drifting/Modelos Propios/exp/", showWarnings = FALSE)
dir.create("~/Desktop/ITBA/Mineria de Datos/dm2024a/src/drifting/Modelos Propios/exp/DR3610/", showWarnings = FALSE)
setwd("~/Desktop/ITBA/Mineria de Datos/dm2024a/src/drifting/Modelos Propios/exp/DR3610/")
