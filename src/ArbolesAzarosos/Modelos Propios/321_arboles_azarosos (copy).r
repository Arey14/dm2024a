...
azar = read.csv("~/Desktop/ITBA/Mineria de Datos/datasets/azarosos2.csv")
for (i in 1:9) {
  

# parmatros experimento
PARAM <- list()
PARAM$experimento <- paste(cbind(as.character(azar[i,1]),as.character(azar[i,2]),as.character(azar[i,3])),collapse = "-")
...
setwd("~/Desktop/ITBA/Mineria de Datos/dm2024a/src/ArbolesAzarosos/") # Establezco el Working Directory
