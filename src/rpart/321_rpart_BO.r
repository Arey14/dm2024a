...
#setwd("~/Desktop/ITBA/Mineria de Datos/dm2024a/src/rpart/")

#cargo MI semilla, que esta en MI bucket
tabla_semillas <- fread( "~/Desktop/ITBA/Mineria de Datos/datasets/mis_semillas.txt" )
ksemilla_azar <- 734471  # 1 es mi primer semilla
